...
const s = StyleSheet.create({
  ...
  section:      { borderRadius: 10, overflow: 'hidden', marginBottom: 8, borderWidth: 1, borderColor: '#e2e8f0' },
  header:       { flexDirection: 'row', alignItems: 'center', padding: 12, backgroundColor: '#f8fafc', gap: 8 },
  tagBadge:     { backgroundColor: '#eef2ff', borderRadius: 5, paddingHorizontal: 7, paddingVertical: 2 },
  tagText:      { fontSize: 10, fontWeight: '800', color: '#6366f1', fontFamily: 'monospace' },
  sectionTitle: { flex: 1, fontSize: 13, fontWeight: '600', color: '#334155' },
  bytes:        { fontSize: 11, color: '#94a3b8' },
  chevron:      { fontSize: 10, color: '#94a3b8', marginLeft: 4 },
  body:         { backgroundColor: '#ffffff' },
  row:          { flexDirection: 'row', padding: 10, borderTopWidth: 1, borderTopColor: '#f1f5f9' },
  rowAlt:       { backgroundColor: '#f8fafc' },
  rowLeft:      { flex: 1, paddingRight: 8 },
  rowRight:     { alignItems: 'flex-end', minWidth: 90 },
  fieldName:    { fontSize: 12, color: '#475569', fontWeight: '600', marginBottom: 2 },
  fieldDesc:    { fontSize: 11, color: '#94a3b8', lineHeight: 16 },
  fieldSize:    { fontSize: 10, color: '#cbd5e1', fontFamily: 'monospace' },
  fieldHex:     { fontSize: 11, color: '#6366f1', fontFamily: 'monospace', marginTop: 2, maxWidth: 110 },
});
